...
- **Vector PDF output** - All processed files exported as cropped PDFs with preserved fidelity
- **Supported input formats**: JPG, PNG, TIFF, PDF
...
6. **Results** are saved as vector-cropped PDF files in a dated folder (e.g., `2025-05-26_processed`)

> **Note:** Original PDFs keep their vector fidelity via page-box cropping. Image inputs are embedded into PDF pages at high quality.
